...
import AMLAnalystDashboard from './pages/AMLAnalystDashboard';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/analyst" element={<AMLAnalystDashboard />} />
        <Route path="/dashboard/analyst/:section" element={<AMLAnalystDashboard />} />
